...
public final class ActivitySecondBinding implements ViewBinding {
  ...
  private ActivitySecondBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivitySecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySecondBinding((ConstraintLayout) rootView, textView);
    }
